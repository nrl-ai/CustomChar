...
LLAMA_API DEPRECATED(
    ...
    "avoid using this, it will be removed in the future, instead - count the "
    "tokens in user code");
...
LLAMA_API enum llama_token_type llama_token_get_type(
...
LLAMA_API struct llama_grammar* llama_grammar_init(
    const llama_grammar_element** rules, size_t n_rules,
