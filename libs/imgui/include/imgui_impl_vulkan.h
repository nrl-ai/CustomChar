...
struct ImGui_ImplVulkan_InitInfo {
  ...
  bool UseDynamicRendering;  // Need to explicitly enable
                             // VK_KHR_dynamic_rendering extension to use this,
                             // even for Vulkan 1.3.
...
IMGUI_IMPL_API void ImGui_ImplVulkanH_DestroyWindow(
    VkInstance instance, VkDevice device, ImGui_ImplVulkanH_Window* wnd,
    const VkAllocationCallbacks* allocator);
