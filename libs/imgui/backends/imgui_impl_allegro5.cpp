...
//  2021-12-08: Renderer: Fixed mishandling of the the ImDrawCmd::IdxOffset
...
bool ImGui_ImplAllegro5_Init(ALLEGRO_DISPLAY* display) {
  ...
  ALLEGRO_VERTEX_ELEMENT elems[] = {
      {ALLEGRO_PRIM_POSITION, ALLEGRO_PRIM_FLOAT_2,
       IM_OFFSETOF(ImDrawVertAllegro, pos)},
      {ALLEGRO_PRIM_TEX_COORD, ALLEGRO_PRIM_FLOAT_2,
       IM_OFFSETOF(ImDrawVertAllegro, uv)},
...
void ImGui_ImplAllegro5_NewFrame() {
  ...
  if (!bd->Texture) ImGui_ImplAllegro5_CreateDeviceObjects();
