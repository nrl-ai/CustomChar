...
// compiled with '#define ImTextureID ImU64'. This is because we need
...
// 'ImTextureID=ImU64' (this is what we do in the
...
static void ImGui_ImplDX12_CreateFontsTexture() {
  ...
  // - Important: to compile on 32-bit systems, this backend requires code to be
  // compiled with '#define ImTextureID ImU64'.
  ...
  // "Properties/C++/Preprocessor Definitions" add 'ImTextureID=ImU64' (this is
  ...
  // Definitions" add 'IMGUI_USER_CONFIG="my_imgui_config.h"' and inside
  ...
  // file!) [Solution 4] command-line: add '/D ImTextureID=ImU64' to your cl.exe
  // command-line (this is what we do in the
  // example_win32_direct12/build_win32.bat file)
  static_assert(
