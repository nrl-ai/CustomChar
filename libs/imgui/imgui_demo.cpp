...
static void ShowDemoWindowWidgets() {
  ...
  if (ImGui::TreeNode("Tooltips")) {
    ...
    // be useful to most users. Passing ImGuiHoveredFlags_Tooltip to
    ...
    // default settings, ImGuiHoveredFlags_Tooltip is equivalent to
  ...
  if (ImGui::TreeNode("Text Input")) {
    ...
    if (ImGui::TreeNode("Completion, History, Edit Callbacks")) {
      ...
      ImGui::SameLine();
      HelpMarker(
          "Here we append \"..\" each time Tab is pressed. See "
  ...
  if (ImGui::TreeNode("Color/Picker Widgets")) {
    ...
    ImGui::SameLine();
    HelpMarker(
        "When not specified explicitly (Auto/Current mode), user can "
  ...
  if (ImGui::TreeNode("Drag/Slider Flags")) {
    ...
    ImGui::SameLine();
    HelpMarker(
        "Always clamp value to min/max bounds (if any) when input manually "
        "with CTRL+Click.");
...
static void ShowDemoWindowTables() {
  ...
  if (ImGui::TreeNode("Basic")) {
    ...
    HelpMarker(
        ...
        "where every cell contains the same type of contents.\n"
  ...
  if (ImGui::TreeNode("Resizable, stretch")) {
    ...
    HelpMarker(
        ...
        "flag as well, this is why the resize borders are still showing when "
        "unchecking this.");
    PopStyleCompact();
  ...
  if (ImGui::TreeNode("Sizing policies")) {
    ...
    HelpMarker(
        ...
        "sizing policies depending on whether Scroll is enabled and the "
  ...
  if (ImGui::TreeNode("Horizontal scrolling")) {
    ...
    HelpMarker(
        ...
        "therefore using Stretch columns + ScrollX together doesn't make "
        "sense.");
    static ImGuiTableFlags flags2 =
  ...
  if (ImGui::TreeNode("Columns widths")) {
    ...
    HelpMarker(
        ...
        "_NoKeepColumnsVisible is set, fixed columns with set width may still "
  ...
  if (ImGui::TreeNode("Context menus")) {
    HelpMarker(
        ...
        "ImGuiTableFlags_ContextMenuInBody we also allow right-clicking over "
        "columns body.");
    static ImGuiTableFlags flags1 =
        ImGuiTableFlags_Resizable | ImGuiTableFlags_Reorderable |
    ...
    HelpMarker(
        ...
        "button (over button) and custom per-colum context menu (over column "
        "body).");
    ...
    if (ImGui::TreeNode("Outputs")) {
      ...
      if (ImGui::TreeNode("WantCapture override")) {
        HelpMarker(
            ...
            "io.WantCaptureKeyboard would be false when hovering and true when "
            "clicking.");
...
static void ShowExampleAppPropertyEditor(bool* p_open) {
  ...
  HelpMarker(
      ...
      "Remember that in many simple cases, you can use ImGui::SameLine(xxx) to "
      "position\n"
